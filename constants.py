...
ARRAY_PATH_SEPARATOR = '|'
DEFAULT_CONFIG_PATH = 'config.json'
MANDATORY_EXISTING_PATH_KEYS = ['master_schema_path', 'branch_schema_path']
MANDATORY_OPTIONAL_PATH_KEYS = ['diff_schema_path', 'common_fields_path', 'missing_fields_path',
                                'additional_fields_path', 'common_intermediate_path', 'master_intermediate_path',
                                'branch_intermediate_path']
